...
After running both scenarios, open Grafana at http://localhost:3000 and go to the provisioned **SWIM dNOTAM — Distributed Tracing Demo** dashboard. You will see:
...
3. **All Service Layer Events** — structured logs from all three services; click any trace in Recent Traces first, then use the Logs button in the trace detail to navigate to related logs
